<template>
  <el-form :inline="inline" :model="form" ref="form" label-width="100px" class="demo-ruleForm">
    <el-form-item v-for="item in formLabel" :key="item.model" :label="item.label">
      ...
      <el-date-picker v-model="form[item.model]" type="date" placeholder="选择日期时间" v-if="item.type === 'date'"> </el-date-picker>
    </el-form-item>
    <el-form-item>
      <slot></slot>
    </el-form-item>
